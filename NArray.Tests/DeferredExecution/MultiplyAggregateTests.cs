...
namespace NArray.Tests
{
    ...
    //        int vectorLength = vectors.First().TotalSize;
    ...
    //    {
    //        var length = vectorPositions.First().Array1.TotalSize;
    //        var sum = new NArray(length, 1);
